...
public class MainActivity extends AppCompatActivity {
    ...
    String HttpURL = "http://10.40.100.227:85/StudentRegister.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StudentName = (EditText)findViewById(R.id.matno);
        StudentPhoneNumber = (EditText)findViewById(R.id.password);
        StudentClass = (EditText)findViewById(R.id.major);
